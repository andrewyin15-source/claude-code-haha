// Enable all EXCEPT problematic q2 features: DAEMON, BG_SESSIONS, TORCH, WORKFLOW_SCRIPTS, CCR_REMOTE_SETUP, UDS_INBOX
const fs = require('fs');
...
walkDir('src');
console.log('Safe version: excludes DAEMON, BG_SESSIONS, TORCH, WORKFLOW_SCRIPTS, CCR_REMOTE_SETUP, UDS_INBOX');
